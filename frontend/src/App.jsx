                ...
                <div className="flex flex-col">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        autoComplete="off" required value={isAutoGeneratedRiddle ? "••••••••••••••••" : newAnswer}
                        ...
                        className={`w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white placeholder-slate-600 focus:outline-none focus:border-white/30 ${isAutoGeneratedRiddle ? 'opacity-50 cursor-not-allowed tracking-widest' : ''}`}
                      />
