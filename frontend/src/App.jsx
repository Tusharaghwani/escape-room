              ...
              <div className="relative z-10 grid lg:grid-cols-2 gap-12">
                <div className="flex flex-col">
                  ...
                  {roomData.doors.filter(d => d.creator === user?.username).length >= 2 ? (
                    ...
                    <form onSubmit={handleCreateDoor} className="flex flex-col gap-4 max-w-lg bg-black/60 p-6 rounded-xl border border-white/10 backdrop-blur-md">
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="password" required value={newAnswer}
